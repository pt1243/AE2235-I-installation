...
set SCIPY_WHEEL_FILENAME=wheels\SciPy-1.8.1-cp310-cp310-win_amd64.whl
set SLYCOT_WHEEL_FILENAME=wheels\slycot-0.4.0-cp310-cp310-win_amd64.whl
...
echo.
%PYTHON_PATH% -m pip install control
echo.
echo Control package successfully installed!
goto endsuccess
